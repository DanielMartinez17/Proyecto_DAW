...
<body>
    ...
    if (isset($_POST['ok'])) {
        ...
        $sql10 = "UPDATE producto SET stok = stok + " . $cantidad . " WHERE id_producto = " . $idProd;
        $resultados = $conn->query($sql10);

        print "<script>window.setTimeout(function() { window.location = '".constant("URL") . "'stok' }, 0);</script>";
    }
    ?>
    ...
    <script>
        ...
        function getData() {
            ...
            let url = "<?php echo constant('URL') ?>views/stok/load.php"
